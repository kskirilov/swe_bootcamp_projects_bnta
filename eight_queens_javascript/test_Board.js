...
import MagicMock from unittest.MagicMock;
...
function test_ctor_negative_number_error(){
    board = board(-1000);
}
...
function test_ctor_infinity_error(){
    board = Board(math.inf)
    assert(board.math.inf == math.inf)
}
